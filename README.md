...
| Name     | Function | Operating System |
|----------|----------|------------------|
| Jump Box | Gateway  | Linux (Ubuntu)            |
| Web 1   | Server         | Linux (Ubuntu)              |
| Web 2   | Server         | Linux (Ubuntu)               |
| Web 3   | Server         | Linux (Ubuntu)               |
| ELK Server | Log Server  | Linux (Ubuntu)  |
### Access Policies
